...
MCP is built on JSON-RPC 2.0 and enables bidirectional communication between clients (like Antigravity Desktop) and servers that provide resources, tools, and prompts.
...
// Used for local integration (Antigravity Desktop default)
```
