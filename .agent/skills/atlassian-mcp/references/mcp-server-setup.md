...
## Antigravity Desktop Configuration

### Basic Setup

Edit your Antigravity Desktop config file:

**macOS:** `~/Library/Application Support/Antigravity/antigravity_desktop_config.json`
**Windows:** `%APPDATA%\Antigravity\antigravity_desktop_config.json`
**Linux:** `~/.config/antigravity/antigravity_desktop_config.json`
