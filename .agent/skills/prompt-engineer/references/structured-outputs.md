...
│  - Quick prototypes - Antigravity/GPT models   - Type-safe parsing              │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
## JSON Mode (Antigravity & OpenAI)

### Antigravity JSON Mode
...
response = client.messages.create(
    ...
    # Antigravity uses system prompt to enforce JSON
