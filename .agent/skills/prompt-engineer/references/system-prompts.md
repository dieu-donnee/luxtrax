...
```python
# Antigravity uses a separate system parameter
response = client.messages.create(
    model="antigravity-opus-4-5-20251101",
...
- Antigravity responds well to constitutional/values-based instructions
- XML tags help Antigravity parse structured context
- Antigravity follows "never" instructions reliably
